...
<body class="antialiased bg-[#F3F8FB]">
    ...
    <section class=" shadow-lg rounded-md mx-auto px-4 py-4 my-10 w-2/6" >
            ...
            <form action="{{route('signin')}}" method="POST">
                ...
                <button type="submit" class="w-full bg-sky-500 py-2 px-4 my-4 rounded-md text-white hover:opacity-70">
                    Sign In
                </button>

                <p class="text-center opacity-60">Don't have an account? <a href="{{route('signup')}}" class="text-sky-500">Create account</a></p>
            </form>
