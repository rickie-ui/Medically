...
<body class="antialiased bg-[#F3F8FB]">
    ...
    <section class=" shadow-lg rounded-md mx-auto px-4 py-4 my-10 w-2/6" >
            ...
            <form action="{{ route('signup')}}" method="POST">
                ...
                <p class="my-4 opacity-50">By registering you agree to the our <a href="#" class="text-sky-500">Terms of Use</a></p>
                <button type="submit" class="w-full bg-sky-500 py-2 px-4 rounded-md text-white hover:opacity-70">Create Account</button>

              <p class="my-8 text-center">Already have an account?<a href="{{route('signin')}}" class="text-sky-500"> Login</a></p>
            </form>
